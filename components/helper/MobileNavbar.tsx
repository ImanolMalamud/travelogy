...
function MobileNavbar({ isOpen, toggleNavbar }: Props) {
  ...
  return (
    ...
    >
      <div className="w-[100vw] h-[100vh] flex flex-col items-center justify-center">
        ...
        <a
          href="#"
          className="relative lg:inline-flex items-center justify-center px-10 py-3 overflow-hidden font-medium tracking-tighter text-white bg-gray-800 rounded-lg group"
        >
