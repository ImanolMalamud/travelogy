...
function Hero() {
  return (
    <div className="relative w-[100%] h-[700px] lg:h-[88vh]">
      ...
      <div className="absolute z-[100] w-[100%] h-[100%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        <div
          data-aos="fade-right"
          className="flex items-center justify-center flex-col w-[100%] h-[100%]"
        >
          ...
          <a
            href="#_"
            className="relative rounded px-14 md:px-28 mt-[-1rem] py-2.5 overflow-hidden group bg-red-500 hover:bg-gradient-to-r hover:from-red-500 hover:to-red-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-red-400 transition-all ease-out duration-300"
          >
